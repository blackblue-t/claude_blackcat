...
**快車道** = 跳過 grill / spec / plan / 跨 session 審查：直接做
（照樣遵守 worklog 紀律與 DESIGN.md / 專案 rules）→ 跑相關的既有
測試 → 自己看一次 diff → 照 commit.md 提交準備。回報時標明走了
快車道。使用者說「快速」「quick」「小改」一律快車道；拿不準就問
一句「快車道還是完整流程？」。其餘 = standard，從 0.1 走起。
