...
description: |
  ...
  觸發時機：用戶說「去 AI 味」「說人話」「這段好 AI」「改自然一點」「幫我潤稿去掉 AI 感」「校對一下再發」，或要求檢查電子報、社群貼文、銷售頁、課程文案、客服回信、簡報、公告、Email 等對外文字的語感。**撰寫或改寫任何給人讀的繁體中文文件時也要觸發**——README、專案說明、技術文件、規格書、交接文件、變更說明、commit 說明的散文段落皆屬之（要讀的是人，就適用）。
...
license: MIT
origin: Raymondhou0917/speak-human-tw v1.4.0
---
